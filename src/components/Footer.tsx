...
export default function Footer({ className, logoUrl = '/images/jdesignslogo.png' }: FooterProps) {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/j-designs',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/j-designs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/j_designs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg leading-relaxed text-base">
              ...
              We specialize in modern web development and design solutions.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <div className="text-center">
            <div className="text-xs text-muted-foreground">
              <span>Images by Nate Grant, Kelly Sikkema, Luca Bravo, Lukas, Louis Hansel, bruce mars on Unsplash and Pexels on Pixabay</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-border/50">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-sm text-muted-foreground">
              © {currentYear} J Designs. All rights reserved.
            </p>
